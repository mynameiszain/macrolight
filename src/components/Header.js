    ...
    <header id="FormHero" className="n-section hero main-hero paddingg">
      ...
      <div className="container-hero w-container">
        <div className="w-layout-grid contentgrid">
          <div id="w-node-d9ea79f5-dd31-1578-4cae-9b311bf347be-a00cfc93" className="n-contentwrapper rightpadding main">
            <header className="n-paragraphwrapper bottommargin-24">
          ...
          <div id="w-node-f5140045-64d5-01d1-8fe4-85d5735bfc36-a00cfc93" className="n-imagewrapper hero">
            <div
              ...
              data-w-id="64fd90f6-8670-c09e-4cb4-2cec9c02b6ad"
              data-animation-type="lottie"
              data-src="https://assets-global.website-files.com/6286650c317fddfbb431b9c1/658be9c762cc519051772727_Hero---animation.json"
              data-loop="0"
              data-direction="1"
              data-autoplay="1"
              data-is-ix2-target="0"
              data-renderer="svg"
              data-default-duration="6.333333333333333"
              data-duration="0"
            >
            </div>
          </div>
